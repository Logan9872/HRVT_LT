...
# 读取数据
dirs = os.listdir("E:/12.13乳酸阈数据处理/12.14户外跑数据/setDataMM/")
for all_files in dirs:
    file_path = "E:/12.13乳酸阈数据处理/12.14户外跑数据/setDataMM/" + all_files
    ...
    # 保存提取的数据
    output_dir = 'E:/12.13乳酸阈数据处理/12.14户外跑数据/setData_1min/'  # 输出文件夹路径

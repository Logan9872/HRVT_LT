...
dirs = os.listdir("C:/Users/Administrator/Desktop/Training/")
for all_files in dirs:
    file_training = "C:/Users/Administrator/Desktop/Training/" + all_files + ""
    file_rr = "C:/Users/Administrator/Desktop/RR/" + all_files + ""

    training_log_data = pd.read_csv(file_training, encoding="unicode_escape")
    ...
    title = all_files[:-4] 
    # 保存合并后的数据
    CSV_data.to_csv("C:/Users/Administrator/Desktop/merageData/" + title + ".csv",  index=False)
